        ...
        <div className="max-w-md text-center px-8">
            ...
            <div className="p-4 rounded-2xl bg-white/10">
              ...
              >
                <path
                  ...
                  d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 10.125h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"
                />
              </svg>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-white/90 leading-relaxed max-w-sm mx-auto">
              Securely share and collaborate on PDF documents with your team in real-time.
            </p>
          </div>
